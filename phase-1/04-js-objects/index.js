...
// ✅ Creating & Accessing Objects
    ...
    // creating object literals
        ...
        // object with no properties (no key / value pairings)
            ...
            // const emptyObject = {}; // object literal
            
            // const emptyObject = new Object(); // object initializer
    ...
    // 2️⃣ Create a function that accepts an object (myObject) and converts it into / returns an array (myArray).
        ...
        // 💡 Consider using a combination of Object.keys and map() in your solution.
            ...
            function convertToArray(myObject) {
                // pull keys to compare by value below
                let objKeys = Object.keys(myObject);
                    
                // if the object has no values...
                if (objKeys.length === 0) {
                    return [];
                }
...
// 🚧 Break Out Activity 2: Modifying / Iterating Over Objects
    ...
    // 1️⃣ Create a function that accepts an object (oldObject), inverts its keys / values, and returns the new object (invertedObject)

        // Example: invertObject({ x: 1, y: 2, z: 3 }) => { 1: x, 2: y, 3: z }

        // 💡 Try making use of a "for...in" iterator to iterate over oldObject's keys.
        ...
        function invertObject(oldObject) {
            ...
            for (const oldKey in oldObject) {
                ...
                invertedObject[newValue] = oldKey;
