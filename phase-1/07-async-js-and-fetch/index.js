// ✅ Request-Response Cycle
    ...
    // async functions => allow us to "wait" before performing additional actions 
        ...
        // asynchronized => occurring sequentially (staggered)
...
// ✅ Handling Promises from .fetch()
    ...
    // .fetch() => a way to load additional data after information is presented to the user

    // fetch('https://api.openbrewerydb.org/breweries') // returns a promise
    
    // // once first Promise is resolved...
    // .then(resp => resp.json()) // ...convert the response into JSON and return a new Promise
...
// ✅ .catch()
    ...
    // fetch('https://api.openbrewerydb.org/brewerie') // returns a promise
    // .then(resp => resp.json()) // returns another promise
    // .then(breweries => {
    //     console.log(breweries);
    // }).catch(error => {
    //     // add other behaviors here (i.e., redirect, make changes to the DOM, etc.)
    //     console.log(error);
    // });
