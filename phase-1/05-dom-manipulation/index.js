...
// ✅ .innerHTML vs. .innerText vs. .textContent
	...
	// let firstDiv = document.getElementById('lecture-goals');
  	...
  	// .innerHTML => retrieves / sets content of HTML tags in HTML format
	...
	// .innerText => retrieves / sets content of HTML tags as plain text minus any styling

		// firstDiv.innerText = "Hey!";

		// console.log(firstDiv.innerText);

	// .textContent => retrieves / sets content of HTML tags as plain text plus any styling
