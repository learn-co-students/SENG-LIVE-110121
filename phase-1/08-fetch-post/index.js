...
// ✅ CRUD with Fetch: GET Requests
    ...
    // .then(resp => resp.json()) // ...convert the JSON response into JS before resolving another promise
...
// 🚧 Break Out Activity 1: GET Requests with json-server
	...
	// 2️⃣ Create a function (renderComment) that:
		...
		//  ✔️ Creates an "h3" (userContent) and sets its text content as the Comment object's "content"

		//  ✔️ Creates a "p" (userName) and sets its text content as "Added by <the Comment object's "name">"
