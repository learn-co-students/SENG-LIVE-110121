...
<details>
    <summary>How should we add a new column to the users table</summary>
    <li>rails g migration AddPasswordDigestToUsers password_digest</li>
...
<details> 
  <summary>Why are we adding password to the strong params</summary>
  <li>This is a value that we expect to receive from an incoming request, through a form that is submitted</li>
</details>
